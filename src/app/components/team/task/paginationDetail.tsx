...
export default function PaginationDetail({ totalPages }: props) {

  const pathname = usePathname(); // urlのパス
  const searchParams = useSearchParams(); // urlのクエリ
  const currentPage = Number(searchParams.get('page')) || 1; // 今のページ
